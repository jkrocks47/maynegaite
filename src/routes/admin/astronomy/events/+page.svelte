...
<svelte:head>
	<title>Astronomy Events - UICSpacetime Admin</title>
</svelte:head>
			...
			<table class="data-table">
				...
				<tbody>
					{#each data.events as event}
						<tr>
							<td class="title-cell">
								<a href="/admin/astronomy/events/{event.id}" class="event-link">{event.title}</a>
							</td>
							<td>{event.date}</td>
							<td class="rsvp-cell">
									...
									<form method="POST" action="?/edit" use:enhance={() => {
										...
										<div class="form-grid">
											...
											<div class="form-group">
												...
												<input type="url" name="locationUrl" value={event.locationUrl || ''} />
											</div>
											<div class="form-group">
												<label>Max Attendees</label>
												<input type="number" name="maxAttendees" min="1" value={event.maxAttendees || ''} />
											</div>
											<div class="form-group checkbox-group">
												<label>
